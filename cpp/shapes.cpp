...
Reta* recToRetas(shapes::Rectangle rec) {
    ...
    p_retas[0] = {{rec.size.x, 0.0f}, {rec.pos.x - rec.size.y / 2, rec.pos.y - rec.size.x / 2}, {0.0f, 1.0f}};
    p_retas[1] = {{0.0f, rec.size.y}, {rec.pos.x - rec.size.y / 2, rec.pos.y - rec.size.x / 2}, {0.0f, 1.0f}};
    p_retas[2] = {{rec.size.x, 0.0f}, {rec.pos.x - rec.size.y / 2, rec.pos.y + rec.size.x / 2}, {0.0f, 1.0f}};
    p_retas[3] = {{0.0f, rec.size.y}, {rec.pos.x + rec.size.y / 2, rec.pos.y - rec.size.x / 2}, {0.0f, 1.0f}};
...
char intercectionRetaCircle(Reta reta, Circle circle, float delta_time) {
    ...
    float t_1 = (-b + sqrt(delta)) / (2*a), t_2 = (-b - sqrt(delta)) / (2*a);
